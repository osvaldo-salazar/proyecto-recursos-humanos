...
<html lang="en">
   ...
   <input type="hidden" id="idcat" value="0">
    <input type="hidden" id="accion" value="crear">
                            ...
                            <div class="card-body">
                                ...
                                <div class="p-3" style="width:100%;margin: 0 auto;">
                                    <div class="form-horizontal" action="">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="txtRegistro">Registro Categoria</label>
                                            <input type="text" class="form-control validacion form-control-lg" id="txtRegistro" value="" placeholder="Nombre de la nueva categoria">
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        while($fila = mysqli_fetch_assoc($consulta)){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>
                                                    <a onclick='editar_categoria($fila[idCategoria])'  class='btn btn-outline-secondary btn-sm edit editarLugar' title='Edit'>
                                                        <i class='fas fa-pencil-alt'></i>
                                                    </a>
                                                    </td>

                                                    <td>
                                                    <a onclick='eliminar_categoria($fila[idCategoria])' class='btn btn-outline-secondary btn-sm' title='Eliminar'>
        ...
        <script src="assets/js/sistema/crear_categoria.js"></script>
        <script src="assets/js/sistema/editar-categoria.js"></script>

        <script src="assets/js/sistema/eliminar-categoria.js"></script>
